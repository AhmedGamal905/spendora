  ...
  <div className="max-w-[85rem] flex justify-between lg:grid lg:grid-cols-3 basis-full items-center w-full mx-auto py-2.5 px-4 sm:px-6 lg:px-8">
    <div className="flex items-center gap-x-3">
      <div className="hidden sm:block">
        {/* Logo */}
        <a className="flex-none rounded-md text-xl inline-block font-semibold focus:outline-none focus:opacity-80" href="../../pro/ecommerce/index.html" aria-label="Preline">
      ...
      <div className="sm:hidden">
        {/* Logo */}
        <a className="flex-none rounded-md text-xl inline-block font-semibold focus:outline-none focus:opacity-80" href="../../pro/ecommerce/index.html" aria-label="Preline">
          <svg className="w-[30px] h-auto" width={36} height={36} viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <div className="hidden lg:flex justify-center items-center gap-x-6">
      <NavLink to="/login" className="text-sm font-medium text-stone-800 hover:text-green-600 dark:text-neutral-300 dark:hover:text-green-500">
        Login
      </NavLink>
      <a href="#" className="text-sm font-medium text-stone-800 hover:text-green-600 dark:text-neutral-300 dark:hover:text-green-500">
        Categories
      </a>
      <a href="#" className="text-sm font-medium text-stone-800 hover:text-green-600 dark:text-neutral-300 dark:hover:text-green-500">
        Expenses
    ...
    <div className="flex justify-end items-center gap-x-2">
      <div className="h-[38px] ">
        ...
        <div className="hs-dropdown [--placement:top-right] [--strategy:absolute] [--auto-close:inside] relative inline-flex">
          <button id="hs-pro-dnad" type="button" className="inline-flex shrink-0 items-center gap-x-1.5 text-start text-stone-800 rounded-full hover:text-stone-600 focus:outline-none focus:text-stone-600 dark:text-neutral-200 dark:hover:text-neutral-400 dark:focus:text-neutral-400" aria-haspopup="menu" aria-expanded="false" aria-label="Dropdown">
            <img className="shrink-0 size-[38px] lg:size-8 rounded-full" src="https://images.unsplash.com/photo-1659482633369-9fe69af50bfb?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=facearea&facepad=3&w=320&h=320&q=80" alt="Avatar" />
          ...
          {/* Account Dropdown */}
          <div className="hs-dropdown-menu hs-dropdown-open:opacity-100 w-60 transition-[opacity,margin] duration opacity-0 hidden z-20 bg-white rounded-xl shadow-[0_10px_40px_10px_rgba(0,0,0,0.08)] dark:shadow-[0_10px_40px_10px_rgba(0,0,0,0.2)] dark:bg-neutral-900" role="menu" aria-orientation="vertical" aria-labelledby="hs-pro-dnad">
            <div className="p-1">
              <a className="flex items-center gap-x-3 py-2 px-3 rounded-lg text-sm text-stone-800 hover:bg-stone-100 disabled:opacity-50 disabled:pointer-events-none focus:outline-none focus:bg-stone-100 dark:text-neutral-300 dark:hover:bg-neutral-800 dark:focus:bg-neutral-800" href="#">
