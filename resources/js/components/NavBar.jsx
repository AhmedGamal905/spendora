                        ...
                        <div className="h-[38px] ">
                            <div className="hs-dropdown [--placement:top-right] [--strategy:absolute] [--auto-close:inside] relative inline-flex">
                                <button
                                    id="hs-pro-dnad"
                                    type="button"
                                    className="inline-flex shrink-0 items-center gap-x-1.5 text-start text-stone-800 rounded-full hover:text-stone-600 focus:outline-none focus:text-stone-600 dark:text-neutral-200 dark:hover:text-neutral-400 dark:focus:text-neutral-400"
                                    aria-haspopup="menu"
                                    aria-expanded="false"
                                    aria-label="Dropdown"
                                >
                                    <img
                                        className="shrink-0 size-[38px] lg:size-8 rounded-full"
                                ...
                                >
                                    {user && (
                                        <div className="p-1">
                                            <a
                                                className="flex items-center gap-x-3 py-2 px-3 rounded-lg text-sm text-stone-800 hover:bg-stone-100 disabled:opacity-50 disabled:pointer-events-none focus:outline-none focus:bg-stone-100 dark:text-neutral-300 dark:hover:bg-neutral-800 dark:focus:bg-neutral-800"
                                                href="#"
                                            >
                                                <svg
                                    ...
                                    <div className="px-5 py-3.5 border-y border-stone-200 dark:border-neutral-800">
                                        <div className="flex justify-between items-center">
                                            <label
                                                ...
                                                className="text-sm text-stone-800 dark:text-neutral-300"
                                            >
                                                Dark mode
                                            </label>
